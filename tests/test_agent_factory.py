...
class TestAgentFactory:
    ...
    @pytest.mark.parametrize("agent_class, method_name, args, kwargs", [
        ...
        (BrandLinkageAgent, "evaluate", [MagicMock(), MagicMock(), "Assets", MagicMock()], {}),
        (DiagnosticsAgent, "evaluate", [MagicMock(), MagicMock(), MagicMock(), "Constraints"], {}),
        (AttentionHeuristicAgent, "evaluate", [MagicMock(), MagicMock(), MagicMock()], {}),
        (IntentSimulationAgent, "evaluate", [[], MagicMock(), MagicMock(), []], {}),
        (ScoringAgent, "aggregate_and_score", [[], MagicMock(), [], MagicMock()], {}),
        (IterationControllerAgent, "manage_iteration", [[], MagicMock(), [], MagicMock()], {}),
    ...
    def test_agent_method_execution(self, mock_client: MagicMock, agent_class: type, method_name: str, args: list, kwargs: dict) -> None:
    ...
    def test_video_generation_agent_special_case(self, mock_client: MagicMock) -> None:
