...
class TestStageConfig:
    ...
    def test_basic_config(self) -> None:
        ...
        config: StageConfig[Any, Any] = StageConfig(
            id="test_stage",
    ...
    def test_config_with_condition(self) -> None:
        """Test stage config with condition."""
        def condition(ctx: dict[str, Any]) -> bool: return ctx.get("run_optional") is True
        config: StageConfig[Any, Any] = StageConfig(
            id="optional_stage",
    ...
    def test_validate_context_missing_key(self) -> None:
        ...
        context: dict[str, Any] = {"other_field": "value"}
        assert config.validate_context(context) is False

    def test_validate_context_has_key(self) -> None:
        ...
        context: dict[str, Any] = {"required_field": "value"}
        assert config.validate_context(context) is True

    def test_validate_context_null_value(self) -> None:
        ...
        context: dict[str, Any] = {"field": None}
        assert config.validate_context(context) is False

    def test_should_run_condition_false(self) -> None:
        ...
        context: dict[str, Any] = {"flag": False}
        assert config.should_run(context) is False

    def test_should_run_condition_true(self) -> None:
    ...
    def test_should_run_condition_exception_runs_stage(self) -> None:
...
class TestPipelineStageRegistry:
    ...
    def test_register_single_stage(self) -> None:
    ...
    def test_register_returns_self(self) -> None:
        ...
        registry = PipelineStageRegistry()
        config: StageConfig[Any, Any] = StageConfig(
            id="test", description="test", agent_factory=MagicMock()
        )
    ...
    def test_register_many(self) -> None:
        ...
        registry = PipelineStageRegistry()
        configs: list[StageConfig[Any, Any]] = [
    ...
    def test_get_stage_exists(self) -> None:
    ...
    def test_resolve_order_two_sequential(self) -> None:
    ...
    def test_resolve_order_two_parallel(self) -> None:
    ...
    def test_resolve_order_complex_dag(self) -> None:
    ...
    def test_resolve_order_circular_dependency_raises(self) -> None:
    ...
    def test_resolve_order_unknown_dependency_raises(self) -> None:
...
class TestPipelineStageRegistryExecute:
    ...
    def test_execute_empty_registry(self) -> None:
        """Test executing empty registry."""
        registry = PipelineStageRegistry()
        results = registry.execute(context={})
        assert results == {}

    def test_execute_single_stage_success(self) -> None:
    ...
    def test_execute_single_stage_uses_run_fallback(self) -> None:
    ...
    def test_execute_skips_conditional_stage(self) -> None:
    ...
    def test_execute_runs_conditional_stage(self) -> None:
    ...
    def test_execute_parallel_stages(self) -> None:
        """Test executing parallel stages concurrently."""
        call_order = []

        def slow_factory(_: Any) -> Any:
            agent = MagicMock()

            def slow_execute(ctx: Any) -> dict[str, Any]:
    ...
    def test_execute_updates_context(self) -> None:
...
class TestPipelineStageRegistryCreateLegacy:
    ...
    def test_create_legacy_returns_registry(self) -> None:
    ...
    def test_create_legacy_has_stages(self) -> None:
    ...
    def test_create_legacy_has_correct_dependencies(self) -> None:
    ...
    def test_create_legacy_eval_parallel_hints(self) -> None:
        """Test eval stages have parallel hints."""
        mock_client = MagicMock()
        registry = PipelineStageRegistry.create_legacy(mock_client)

        clarity_config = registry.get_stage("eval_clarity")
        assert clarity_config is not None
